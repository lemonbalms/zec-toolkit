...
hooks:
  Stop:
    - hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/zec/handle-agent-hook.sh\" team-quality-completion"
          timeout: 10
---

You are a quality assurance specialist working as part of a ZEC agent team.
