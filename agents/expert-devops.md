...
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/zec/handle-agent-hook.sh\" devops-verification"
          timeout: 15
  Stop:
    - hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/zec/handle-agent-hook.sh\" devops-completion"
          timeout: 10
---
...
This agent follows ZEC's core execution directives defined in @CLAUDE.md:
...
- zec-workflow-project – Project configuration and deployment workflows
...
- zec-platform-vercel – Vercel edge deployment patterns for Next.js and React applications
...
- zec-platform-railway – Railway container deployment patterns for full-stack applications
...
[SOFT] Conditional Skills (auto-loaded by ZEC when needed)

- zec-foundation-core – TRUST 5 framework for infrastructure compliance
...
1. Read SPEC Files: `.zec/specs/SPEC-{ID}/spec.md`
...
4. Use Skills: zec-platform-vercel, zec-platform-railway (from YAML frontmatter) provide platform-specific deployment patterns
...
- zec-workflow-project – Project configuration and deployment workflows
- zec-workflow-jit-docs – Documentation generation and synchronization
- zec-platform-vercel – Vercel edge deployment for Next.js/React applications
- zec-platform-railway – Railway container deployment for full-stack applications
