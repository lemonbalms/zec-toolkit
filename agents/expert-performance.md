...
- zec-lang-python – Python performance profiling and optimization patterns
- zec-lang-typescript – TypeScript/JavaScript performance optimization patterns
- zec-workflow-testing – Testing strategies and performance test patterns
...
Create `.zec/docs/performance-analysis-{SPEC-ID}.md`:
