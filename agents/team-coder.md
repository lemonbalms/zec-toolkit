...
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/zec/handle-agent-hook.sh\" team-coder-verification"
          timeout: 15
---

You are an implementation specialist working as part of a ZEC agent team.
