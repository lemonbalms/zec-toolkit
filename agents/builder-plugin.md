...
- ZEC - User requests new plugin creation
...
Related Skills:
- zec-foundation-claude - Claude Code authoring patterns, component references
- zec-workflow-project - Project management and configuration
...
Compliance: Claude Code Official Plugin Standards + ZEC-ADK Conventions
