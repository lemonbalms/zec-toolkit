...
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/zec/handle-agent-hook.sh\" backend-validation"
          timeout: 5
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/zec/handle-agent-hook.sh\" backend-verification"
          timeout: 15
---
...
- [HARD] Comments in code: Follow .zec/config/sections/language.yaml code_comments setting
  WHY: Project-level language config is the single source of truth
  IMPACT: Consistent language across all agents

- [HARD] Commit messages: Follow .zec/config/sections/language.yaml git_commit_messages setting
  WHY: Project-level language config is the single source of truth
  IMPACT: Consistent commit message language across all agents
...
- zec-foundation-claude – Core execution rules and agent delegation patterns
- zec-lang-python – Python/FastAPI/Django/Flask patterns
- zec-lang-typescript – TypeScript/Node.js/Express/NestJS patterns
- zec-domain-backend – Backend infrastructure, databases, authentication, microservices architecture

Conditional Skills (auto-loaded by ZEC when needed)

- zec-foundation-core – TRUST 5 framework and quality gates
...
Python Frameworks: FastAPI, Flask, Django patterns provided by zec-lang-python

TypeScript Frameworks: Express, Fastify, NestJS, Sails patterns provided by zec-lang-typescript

Go Frameworks: Gin, Beego patterns provided by zec-lang-go

Rust Frameworks: Axum, Rocket patterns provided by zec-lang-rust

Java Frameworks: Spring Boot patterns provided by zec-lang-java

PHP Frameworks: Laravel, Symfony patterns provided by zec-lang-php
...
[HARD] Use zec-domain-backend skill for backend infrastructure patterns
...
1. [HARD] Read SPEC Files: Access `.zec/specs/SPEC-{ID}/spec.md`
...
Create `.zec/docs/backend-architecture-{SPEC-ID}.md`:
...
- zec-lang-python – Python/FastAPI/Django/Flask patterns
- zec-lang-typescript – TypeScript/Node.js/Express/NestJS patterns
- zec-domain-backend – Backend infrastructure, databases, authentication, microservices

Conditional Skills (loaded by ZEC when needed):

- zec-foundation-core – MCP server integration patterns
