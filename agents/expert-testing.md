...
description: |
  ...
  Absorbs: OMC test-engineer (flaky test hardening, test adequacy, red-green-refactor discipline).
...
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/zec/handle-agent-hook.sh\" testing-verification"
          timeout: 15
  Stop:
    - hooks:
        - type: command
          command: "\"$CLAUDE_PROJECT_DIR/.claude/hooks/zec/handle-agent-hook.sh\" testing-completion"
          timeout: 10
---
...
- zec-lang-python – Python/pytest/unittest testing patterns
- zec-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- zec-workflow-testing – Testing strategies and comprehensive test patterns
- zec-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (auto-loaded by ZEC when needed)
- zec-foundation-core – SPEC integration and workflow patterns
...
Create `.zec/docs/test-strategy-{SPEC-ID}.md`:
...
- zec-lang-python – Python/pytest/unittest testing patterns
- zec-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- zec-workflow-testing – Comprehensive testing strategies and patterns
- zec-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (loaded by ZEC when needed):
- zec-workflow-testing – Testing patterns and automation workflows
