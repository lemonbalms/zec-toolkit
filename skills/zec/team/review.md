...
- Triggered by: /zec review --team OR explicit multi-perspective review request
...
All four reviewers run in parallel. Messages from teammates are delivered automatically to ZEC.
