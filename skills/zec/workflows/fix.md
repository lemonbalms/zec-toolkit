...
See .claude/rules/zec/workflow/mx-tag-protocol.md for complete tag rules.
...
Snapshot location: $CLAUDE_PROJECT_DIR/.zec/cache/fix-snapshots/
...
Resume commands:
- /zec:fix --resume (uses latest snapshot)
- /zec:fix --resume fix-20260119-143052 (uses specific snapshot)
...
14. Save snapshot to $CLAUDE_PROJECT_DIR/.zec/cache/fix-snapshots/
