...
- Description content
- Priority level
- Environment information (ZEC version, OS)
...
- Phase 1 collects all user input at ZEC orchestrator level
...
- Phase 1: ZEC orchestrator (AskUserQuestion for feedback collection)
