...
After Phase 4 consolidation, ZEC MUST evaluate whether to call Skill("simplify").
...
- Auto-fix issues (Recommended): Run /zec fix to automatically resolve Level 1-2 issues found in the review. Critical and complex issues will require manual attention.
...
- Export report: Save the review report to .zec/reports/ for future reference and tracking.
...
- Phase 1: ZEC orchestrator (change identification via git)
- Phase 2-3: manager-quality subagent (multi-perspective analysis) OR expert-security subagent (if --security)
- Phase 4-5: ZEC orchestrator (consolidation and user interaction)
