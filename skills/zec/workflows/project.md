---
name: zec-workflow-project
description: >
  Generates project documentation from codebase analysis or user input.
  Creates product.md, structure.md, and tech.md in .zec/project/ directory,
  plus architecture maps in .zec/project/codemaps/ directory.
...
Purpose: Generate project documentation through smart questions and codebase analysis. Creates product.md, structure.md, and tech.md in .zec/project/ directory, plus architecture documentation in .zec/project/codemaps/ directory.
...
- Existing Project (Recommended): Your codebase will be automatically analyzed to generate accurate documentation. ZEC scans your files, architecture, and dependencies to create product.md, structure.md, and tech.md.
...
- New Project (Recommended): ZEC will guide you through a short interview to understand your project goals, technology choices, and key features. This creates the foundation documents for all future development.
- Existing Project: Choose this if your code exists elsewhere and you want to point ZEC to analyze it.
...
- Fresh Documentation: When .zec/project/ is empty, generate all three files
...
- Proceed with documentation generation (Recommended): ZEC will generate product.md, structure.md, and tech.md based on the analysis above. You can review and edit the documents afterwards.
...
Purpose: Generate architecture documentation in `.zec/project/codemaps/` directory based on codebase analysis results from Phase 1.
...
Output Files (in `.zec/project/codemaps/` directory):
...
Skip Conditions:
- New projects with no existing code (Phase 0.5 path): Skip codemaps generation, create placeholder `.zec/project/codemaps/overview.md` with project goals only
...
Goal: Automatically set the `development_mode` in `.zec/config/sections/quality.yaml` based on the project analysis results from Phase 0 and Phase 1.
...
Implementation:
- Read current `.zec/config/sections/quality.yaml`
...
- .zec/project/product.md → Project name, description, core features, target audience
- .zec/project/structure.md → Top-level directory structure, architecture pattern
- .zec/project/tech.md → Primary language, framework, key dependencies
- .zec/project/codemaps/ → Number of codemaps files generated (if any)
...
Codemaps: [N files generated] in .zec/project/codemaps/
...
- Create SPEC (Recommended): Run /zec plan to define your first feature specification. This is the natural next step after project setup.
...
- Phase 0-2: ZEC orchestrator (AskUserQuestion for all user interaction)
...
- Phase 3.7: ZEC orchestrator (automatic development_mode configuration, no user interaction)
