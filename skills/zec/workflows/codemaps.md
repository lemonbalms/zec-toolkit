---
name: zec-workflow-codemaps
description: >
  Scan codebase and generate architecture documentation in .zec/project/codemaps/ directory.
...
Purpose: Scan the codebase and generate architecture documentation in `.zec/project/codemaps/` directory. Creates human-readable and AI-consumable maps of modules, dependencies, entry points, and interaction patterns.
...
- Existing .zec/project/codemaps/ content (if --force not set, for incremental updates)
...
- `.zec/project/codemaps/{area}/overview.md`
- `.zec/project/codemaps/{area}/modules.md`
- `.zec/project/codemaps/{area}/dependencies.md`
...
- Compare with existing .zec/project/codemaps/ to highlight changes (if not --force)
...
- Generate project documentation: Run /zec project to create or update product.md, structure.md, tech.md alongside the new codemaps.
- Review codemaps manually: Open the generated files in .zec/project/codemaps/ directory for manual review and editing.
...
- Phase 4: ZEC orchestrator (verification checks)

## Execution Summary

1. Parse arguments (extract flags: --force, --area, --format, --depth)
2. Check for existing .zec/project/codemaps/ directory content
