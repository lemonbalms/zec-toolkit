...
Guidelines for creating ZEC skills following the Agent Skills open standard (agentskills.io).

## YAML Frontmatter Schema

ZEC skills follow the Agent Skills standard with ZEC-specific extensions.
...
- ZEC convention: Use CSV format for consistency with existing skills
...
- Conditional: AskUserQuestion (ZEC only), Task (managers only)
...
- Mark ZEC extension fields with standardized comments
