...
Guidelines for creating custom agents in ZEC-ADK.
...
- ZEC-ADK system agents: `.claude/agents/zec/<agent-name>.md` (zec subdirectory)
...
- ZEC agents run as subagents, so this restriction is not currently applicable
